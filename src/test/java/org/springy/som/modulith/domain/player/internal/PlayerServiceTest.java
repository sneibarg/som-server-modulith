...
class PlayerServiceTest {
    ...
    void getAllPlayerAccounts_ok() {
        List<PlayerDocument> accounts = List.of(mock(PlayerDocument.class), mock(PlayerDocument.class));
    ...
    void getAllPlayerAccountsFallback_returnsEmptyList() throws Exception {
        ...
        List<PlayerDocument> out = (List<PlayerDocument>) m.invoke(service, new RuntimeException("cb"));

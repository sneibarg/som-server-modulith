...
public class PlayerControllerTest {
    ...
    void createPlayer_returns201() throws Exception {
        PlayerDocument input = new PlayerDocument();
        input.setId("I1");
        ...
        PlayerDocument saved = new PlayerDocument();
        saved.setId("I1");
        ...
        when(playerService.createPlayerAccount(any(PlayerDocument.class))).thenReturn(saved);
        ...
        verify(playerService).createPlayerAccount(any(PlayerDocument.class));
    }

...
class ClassServiceTest {
    ...
    void getAllClasses_ok_returnsList() {
        List<RomClass> expected = List.of(new RomClass(), new RomClass());
        when(repo.findAll()).thenReturn(expected);

        List<RomClass> actual = service.getAllClasses();
    ...
    void getRomClassById_ok_returnsEntityOrNull_passthrough() {
        RomClass rc = new RomClass();
        when(repo.findRomClassById("C1")).thenReturn(rc);

        RomClass actual = service.getRomClassById("C1");
    ...
    void createRomClass_blankId_throwsInvalid() {
        RomClass rc = mock(RomClass.class);
    ...
    void createRomClass_ok_saves() {
        ...
        RomClass actual = service.createRomClass(rc);
    ...
    void getAllRomClassesFallback_returnsEmptyList_reflection() throws Exception {
        ...
        List<RomClass> result = (List<RomClass>) m.invoke(service, new RuntimeException("cb"));

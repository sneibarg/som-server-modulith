...
public class SpecialControllerTest {
    ...
    void createSpecial_returns201() throws Exception {
        Special input = new Special();
        input.setId("I1");
        input.setAreaId("A1");

        Special saved = new Special();
        saved.setId("I1");
        saved.setAreaId("A1");

        when(specialService.createSpecial(any(Special.class))).thenReturn(saved);
        ...
        verify(specialService).createSpecial(any(Special.class));
    }

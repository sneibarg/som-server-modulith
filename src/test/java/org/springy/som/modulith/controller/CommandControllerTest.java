...
import org.springy.som.modulith.exception.command.CommandNotFoundException;
...
import org.springy.som.modulith.exception.command.CommandApiExceptionHandler;
...
public class CommandControllerTest {
    ...
    void getCommandById_blankId_becomes400ProblemDetail() throws Exception {
        when(commandService.getCommandById(anyString())).thenThrow(new InvalidCommandException("Command id must be provided"));
    ...
    void createCommand_returns201() throws Exception {
        ...
        when(commandService.createCommand(any(Command.class))).thenReturn(saved);
        ...
        verify(commandService).createCommand(any(Command.class));
    }

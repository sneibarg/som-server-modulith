...
import org.springy.som.modulith.exception.ApiExceptionHandler;
...
class AreaControllerTest {
    ...
    void getAllAreas_persistenceDown_becomes503ProblemDetail() throws Exception {
        when(areaService.getAllAreas()).thenThrow(new AreaPersistenceException("Failed to load areas", new RuntimeException("db")));

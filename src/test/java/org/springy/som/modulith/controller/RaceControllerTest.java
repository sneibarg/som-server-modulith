...
import org.springy.som.modulith.exception.race.RomRaceApiExceptionHandler;
...
public class RaceControllerTest {
    ...
    void createPlayer_returns201() throws Exception {
        RomRace input = new RomRace();
        input.setId("I1");
        input.setName("scaryMob");
        
        RomRace saved = new RomRace();
        saved.setId("I1");
        saved.setName("scaryMob");
        
        when(raceService.createRomRace(any(RomRace.class))).thenReturn(saved);
        ...
        verify(raceService).createRomRace(any(RomRace.class));
    }
